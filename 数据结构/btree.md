...
>
> 在计算机科学中，[B 树](https://zh.wikipedia.org/wiki/B-tree)是一种自平衡树数据结构，它维护排序数据并允许在对数时间内搜索、顺序访问、插入和删除。 B 树概括了二叉搜索树，允许节点具有两个以上的子节点。与其他自平衡二叉搜索树不同，B 树非常适合读写相对较大数据块的存储系统，例如数据库和文件系统。
...
<img src="../resource/B-tree.png" alt="image" style="zoom:50%;" />
...
![image](../resource/B_tree_insertion_example.png)
